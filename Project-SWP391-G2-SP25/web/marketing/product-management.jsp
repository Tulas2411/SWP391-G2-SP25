                    ...
                    <div class="container mb-4">
                        <div class="row">
                            ...
                            <form action="${contextPath}/marketing/product-management" method="GET" class="row g-3">
                                <div class="col-md-3">
                                    <label for="genderFilter" class="form-label">Loại sản phẩm</label>
                    ...
                    <tbody>
                        <c:forEach items="${products}" var="p" varStatus="status">
                            <tr>
                                ...
                                <td><img src="${contextPath}/${p.imageLink} " width="90" height="60" alt="alt"/></td>
                                <td>${p.productName} </td>
                                ...
                                <td style="width: 150px"><span style="color: ${p.status eq 'Active' ? 'green' : 'red'}">
                                ...
                                <td >
                                    <button type="button" class="btn btn-info btn-sm"
                                            ...
                                            data-image="${contextPath}/${p.imageLink}">  <!-- Add Image Path -->
        ...
        <div class="modal-content">
            <form action="${contextPath}/marketing/product-management" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="provider" class="form-label">Thời gian bảo hành (Năm)</label>
                        <input type="number" min="1" class="form-control" id="provider" name="warrantyPeriod" required>
                        <div class="invalid-feedback">Vui lòng nhập thời gian bảo hành.</div>
                    </div>

                    <div class="mb-3">
                        <label for="price"  class="form-label">Giá</label>
                        <input type="number" min="1" class="form-control" id="price" name="price" required min="0">
                        <div class="invalid-feedback">Vui lòng nhập giá hợp lệ.</div>
                    </div>

                    <div class="mb-3">
                        <label for="amount" class="form-label">Số lượng</label>
                        <input type="number" min="1" class="form-control" id="amount" name="amount" required min="1">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="imageFile" name="description"></textarea>
