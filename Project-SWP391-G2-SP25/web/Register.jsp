    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            // Hiển thị thông báo lỗi khi không thể tạo tài khoản
                ...
                document.getElementById("alert").style.backgroundColor = "#f8d7da";
                document.getElementById("alert").style.color = "#721c24";
                document.getElementById("alert-message").textContent = "Error: Email already exists.";
            } else if (status === "username_exists") {
                document.getElementById("alert").style.display = "block";
                document.getElementById("alert").style.backgroundColor = "#f8d7da";
                document.getElementById("alert").style.color = "#721c24";
                document.getElementById("alert-message").textContent = "Error: Username already exists.";
            } else if (status === "phone_exists") {
                document.getElementById("alert").style.display = "block";
                document.getElementById("alert").style.backgroundColor = "#f8d7da";
                document.getElementById("alert").style.color = "#721c24";
                document.getElementById("alert-message").textContent = "Error: Phone number already exists.";
            }
        </script>
