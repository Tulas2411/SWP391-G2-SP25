...
@WebServlet("/admin/UpdateProfileRoleAdminServlet")
public class UpdateProfileRoleAdminServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("UserProfileRole.jsp").forward(request, response);
    }
}
