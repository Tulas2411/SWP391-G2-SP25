        ...
        <main class="main">
            <div class="main__gird gird">
                ...
                <div class="main">
                    <div class="container">
                        <%
                            String result = (String) request.getAttribute("transResult");
                        ...
                        <%}else{%>
                        <div class="thank-you-message" style="text-align: center; margin: 50px 0;">
                            <h1 style="font-size: 48px; color: red; font-weight: bold; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2);">
                                Đơn hàng của bạn đã đặt hàng thất bại!
                            </h1>
                            <p style="font-size: 24px; color: #333; margin-top: 20px;">
