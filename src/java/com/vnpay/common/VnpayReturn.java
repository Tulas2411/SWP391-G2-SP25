    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (signValue.equals(vnp_SecureHash)) {
                ...
                order = oDAO.getOrderByID(Integer.parseInt(orderId));
                ...
                JsonArray productsArray = (JsonArray) session.getAttribute("productsArray");
                if (transSuccess) {
                ...
                response.sendRedirect("/Project-SWP391-G2-SP25/CartCompletion?transResult=" + transSuccess);
            } else {
                //RETURN PAGE ERROR
