...
public class BlogDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        MarketingPostsDAO mpDAO = new MarketingPostsDAO();
        MarketingPosts m = mpDAO.getMarketingPostByID(id);
        Map<String, PostCategory> list = mpDAO.getAllPostCategories();
        request.setAttribute("post", m);
