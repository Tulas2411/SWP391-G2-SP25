 ...
 * @author daoducdanh
 */
@WebServlet(name = "SaleManagerStatisticController", urlPatterns = {"/SaleManager/StatisticsManager"})
public class SaleManagerStatisticController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("StatisticsManager.jsp").forward(request, response);
    }
